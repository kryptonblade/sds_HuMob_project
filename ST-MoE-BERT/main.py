...
def main():
    ...
    # Only pass subsample_number if subsample is True
    data_loader_kwargs = {
        'city': args.city,
    ...
    if args.subsample:
        data_loader_kwargs['subsample_number'] = args.subsample_number
    
    train_loader, test_df, _ = prepare_data_loader(**data_loader_kwargs)
