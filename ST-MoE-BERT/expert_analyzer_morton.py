...
def analyze_model_experts( city='A', device='cuda', num_batches=20):
    """Main function to analyze expert specializations in a trained model"""
    model_path="checkpoints/best_mobility_bert_moe_dtw_145.89.pth"
    ...
    if analysis_results:
        ...
        # Visualize
        analyzer.visualize_expert_usage(analysis_results, 'expert_usage_morton3.png')
        
        # Generate report
        report = analyzer.generate_report(analysis_results, interpretations, 'expert_analysis_report_morton3.txt')
        print(report)
